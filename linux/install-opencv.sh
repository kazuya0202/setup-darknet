...
sudo apt-fast install -y qt5-default libvtk6-dev

# Media I/O:
sudo apt-fast install -y zlib1g-dev libjpeg-dev libwebp-dev libpng-dev libtiff5-dev libjasper-dev libopenexr-dev libgdal-dev

# Video I/O:
sudo apt-fast install -y libdc1394-22-dev libavcodec-dev libavformat-dev libswscale-dev libtheora-dev libvorbis-dev libxvidcore-dev libx264-dev yasm libopencore-amrnb-dev libopencore-amrwb-dev libv4l-dev libxine2-dev

# Parallelism and linear algebra libraries:
sudo apt-fast install -y libtbb-dev libeigen3-dev

# Python:
sudo apt-fast install -y python-dev python-tk python-numpy python3-dev python3-tk python3-numpy

# Java:
sudo apt-fast install -y ant default-jdk

# Documentation:
sudo apt-fast install -y doxygen
